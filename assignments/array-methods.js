...
const allCapsJSON = JSON.stringify(allCaps);
console.log(allCapsJSON);
...
const largeShirtsJSON = JSON.stringify(largeShirts);
console.log(largeShirtsJSON);
...
// Problem 1
// To spam them with future opportunties
...
// Problem 2
// List of people who do lasrge donations

let donationsOver200 = [];
donationsOver200 = runners.filter((item) => item.donation > 200);
const donationsOver200JSON = JSON.stringify(donationsOver200);
console.log(donationsOver200JSON);


// Problem 3

let companyNameShirtSize = [];
runners.forEach(function(item){
	companyNameShirtSize.push(item.company_name, item.shirt_size);
});

const companyNameShirtSizeJSON = JSON.stringify(companyNameShirtSize);
console.log(companyNameShirtSizeJSON);